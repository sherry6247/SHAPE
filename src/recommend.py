...
from util import llprint, sequence_metric, sequence_metric_v2, sequence_output_process, ddi_rate_score, get_n_params, print_result
...
def eval(model, eval_dataloader, voc_size, epoch, device, TOKENS, args):
    ...
    # # ddi rate
    ddi_rate = ddi_rate_score(smm_record, path='/home/lsc/model/lsc_code/useGeneration2Drug/COGNet/data/ddi_A_final.pkl')
    # ddi_rate = 0.
